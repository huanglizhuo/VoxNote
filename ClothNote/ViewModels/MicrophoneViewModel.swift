...
class MicrophoneViewModel: ObservableObject {
    ...
    init(transcriptionEngine: TranscriptionEngine, captureService: AudioCaptureService, noteStore: NoteStore) {
        ...
        case .notDetermined:
            Task {
                ...
                if granted {
                    ...
                    error = "Microphone permission denied. Please grant access in System Settings > Privacy & Security > Microphone."
                }
            }
        default:
            error = "Microphone permission denied. Please grant access in System Settings > Privacy & Security > Microphone."
    ...
    private func beginCapture() {
        do {
            var note = Note(source: .microphone)
            ...
            try captureService.startCapture(outputFileURL: audioURL) { samples in
